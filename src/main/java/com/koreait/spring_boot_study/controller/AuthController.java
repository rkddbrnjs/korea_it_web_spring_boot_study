...
public class AuthController {
    ...
    //int는 null을 허용안하기 때문에 값이 없음의 상태가 될 수 있다.
    //그래서 required = false를 했지만 에러가 뜸 => Integer로 해야 null로 받을 수 있다.
    //만약 필수값이 false이고 기본값이 설정되어 있다면 필수값 성정이 무의미다..
